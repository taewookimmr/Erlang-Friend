...
-import(io_widget,[get_state/1, insert_str/2, set_prompt/2, set_state/2, set_title/2, set_handle/2, update_state/3]).
...
test() ->
    connect("localhost", 2223, "AsDT67aQ", "general", "joe"),
    connect("localhost", 2223, "AsDT67aQ", "general", "jerry"),
    connect("localhost", 2223, "AsDT67aQ", "general", "joyboy"),
    connect("localhost", 2223, "AsDT67aQ", "general", "joice").
